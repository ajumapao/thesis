                  ...
                  ?>
                    ...
                    <form method="post" action="query/register_employer.php">
                      <div class="form-group">
                        ...
                        <input type="text" name="emp_name" class="form-control" placeholder="Enter Student's Name"  required="">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" name="emp_email" class="form-control" placeholder="Enter Student's Email" required="">
                      </div>
                      <div class="form-group">
                        <label>Practicum Taken</label>
                        <select name="type" class="form-control" required="">
                          <option value="">Choose</option>
                          <option value="enabled">Practicum 1</option>
                          <option value="company">Practicum 2</option>
                        </select>
                      </div>
                      <div class="form-group">
          ...
          <div class="container text-center">
            <div class="row">
              <div class="col-md-6 col-md-offset-3">
                ...
                <hr/>
                <p><i class="fa fa-check"></i> Manage, create and delete your <title> Internship Portal - UCLM </title> alerts</p>
